...
craftingTable.addShapedMirrored("shaped78", <item:minecraft:andesite>, [
    [<item:minecraft:cobblestone>, <item:minecraft:gray_dye>]
]);
craftingTable.addShapedMirrored("shaped79", <item:minecraft:cobblestone>, [
    [<item:minecraft:cobblestone>, <item:minecraft:white_dye>]
]);
craftingTable.addShapedMirrored("shaped80", <item:minecraft:granite>, [
    [<item:minecraft:cobblestone>, <item:minecraft:red_dye>]
]);
...
craftingTable.removeRecipe(<item:village_employment:iron_golem_helmet>);
craftingTable.removeRecipe(<item:village_employment:iron_golem_chestplate>);
craftingTable.removeRecipe(<item:village_employment:iron_golem_leggings>);
craftingTable.removeRecipe(<item:village_employment:iron_golem_boots>);
craftingTable.addShaped("shaped109", <item:minecraft:chest>, [
...
craftingTable.addShapeless("chest", <item:minecraft:chest>, [<item:charm:oak_chest>]);
craftingTable.addShapeless("chest1", <item:minecraft:chest>, [<item:quark:oak_chest>]);
craftingTable.addShaped("shaped110", <item:minecraft:crafting_table>, [
    [<item:minecraft:oak_planks>, <item:minecraft:oak_planks>],
    [<item:minecraft:oak_planks>, <item:minecraft:oak_planks>]
]);
craftingTable.removeRecipe(<item:minecraft:totem_of_undying>);
craftingTable.removeRecipe(<item:village_employment:orb_of_dominance_staff>);
craftingTable.removeRecipe(<item:village_employment:orb_of_dominance>);
craftingTable.removeRecipe(<item:theabyss:auto_smelt_pick_axe>);
craftingTable.removeRecipe(<item:theabyss:unstable_obsidian>);
craftingTable.addShaped("network_book", <item:patchouli:guide_book>.withTag({"patchouli:book": "storagenetwork:network_book" as string}), [
    [<tag:items:forge:dusts/redstone>, <tag:items:forge:dusts/redstone>, <tag:items:forge:dusts/redstone>],
	[<tag:items:forge:dusts/redstone>, <item:minecraft:book>, <tag:items:forge:dusts/redstone>],
    [<tag:items:forge:dusts/redstone>, <tag:items:forge:dusts/redstone>, <tag:items:forge:dusts/redstone>]
]);
craftingTable.addShaped("outvoted", <item:patchouli:guide_book>.withTag({"patchouli:book": "outvoted:book" as string}), [
    [<tag:items:starmute:blackstone_blocks>, <tag:items:starmute:blackstone_blocks>, <tag:items:starmute:blackstone_blocks>],
	[<tag:items:starmute:blackstone_blocks>, <item:minecraft:book>, <tag:items:starmute:blackstone_blocks>],
    [<tag:items:starmute:blackstone_blocks>, <tag:items:starmute:blackstone_blocks>, <tag:items:starmute:blackstone_blocks>]
]);
craftingTable.addShaped("enchantment_info", <item:minecraft:written_book>.withTag({pages: ["{\"text\":\"\\n\\n   Enchantment Guide\\n            v1.0\\n\\n     by Hypermoron\\n\\n\\n\\nCreated because I had no idea what any of them did and the documentation was terrible.\"}" as string, "{\"text\":\"§lAerial Affinity§r\\n§oBoots§r\\n\\nIncreases mining rate when off the ground.\"}" as string, "{\"text\":\"§lAshen Pages§r\\n§oBlazing Journal§r\\n\\nCurse enchantment. Makes journal's manual charging on pyromancer's table impossible, but slowly regenerates blaze charges.\\nFound on the journal dropped by the Unburned boss.\"}" as string, "{\"text\":\"§lBackstabbing§r\\n§oKnife§\\n\\nMax level: 3§r\\n\\nMultiplies damage when striking from behind, starting with 1.4x at level 1 and adding .4 to the multiplier for each level.\"}" as string, "{\"text\":\"§lBlazing Wounds§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, axe attacks on ignited enemies make them burst with lava, dealing extra damage. \"}" as string, "{\"text\":\"§lBounce§r\\n§oBoomerang\\nMax level: 3§r\\n\\nMakes the boomerang bouncier when it hits walls.\"}" as string, "{\"text\":\"§lBreakthrough§r\\n§oMace§r\\n\\nAttacks disable shields.\"}" as string, "{\"text\":\"§lEnd Veil§r\\n§oHelmet§r\\n\\nAllows you to look at endermen without angering them.\"}" as string, "{\"text\":\"§lFire Bite§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nGrants a 70 percent chance for the target to burn.\"}" as string, "{\"text\":\"§lGoliath Slayer§r\\n§oSlingshot (Pyromancer)\\nMax level: 5§r\\n\\nProjectiles deal more damage to bigger enemies.\"}" as string, "{\"text\":\"§lHealth Steal§r\\n§oSword\\nMax level: 3§r\\n\\nSteals some health from the target.\"}" as string, "{\"text\":\"§lHook§r\\n§oHogwhip§r\\n\\nMoves you toward the struck enemy.\"}" as string, "{\"text\":\"§lInfernal Harvest§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, hoe attacks ignite enemies in a large area.\"}" as string, "{\"text\":\"§lLavawaxed§r\\n§oStraddleboard§r\\n\\nGives users fire resistance while using the straddleboard.\"}" as string, "{\"text\":\"§lLegerdemain§r\\n§oSlingshot (Pyromancer)\\nMax level: 3§r\\n\\nSlingshot projectiles have a chance to spawn a copy.\"}" as string, "{\"text\":\"§lLightspeed§r\\n§oHogwhip§r\\n\\nHogwhip attacks are almost instant, but damage is lowered.\"}" as string, "{\"text\":\"§lLuck of Thunder§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nGrants a 15 percent chance for lightning to strike the target.\"}" as string, "{\"text\":\"§lPoison Blade§r\\n§oSword\\nMax level: 3§r\\n\\nAfflicts the target with Poison.\"}" as string, "{\"text\":\"§lResilience§r\\n§oSlingshot (Pyromancer)\\nMax level: 2§r\\n\\nIncreases slingshot projectile range.\"}" as string, "{\"text\":\"§lReturning Board§r\\n§oStraddleboard§r\\n\\nReturns the straddleboard to the user after breaking it.\"}" as string, "{\"text\":\"§lRush§r\\n§oMace\\nMax level: 3§r\\n\\nIncreases mace damage if you are moving faster than the target.\"}" as string, "{\"text\":\"§lScalding Spikes§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, mace attacks create fire streams from the target.\"}" as string, "{\"text\":\"§lSerpent Charmer§r\\n§oStraddleboard§r\\n\\nWhile using the straddleboard, bone serpents in the nether will be passive toward the player.\"}" as string, "{\"text\":\"§lStasis§r\\n§oSlingshot (Supplementaries)§r\\n\\nAllows slingshot projectile to ignore gravity.\"}" as string, "{\"text\":\"§lStraddle Jump§r\\n§oStraddleboard§r\\n\\nIncreases the straddleboard user's jump height.\"}" as string, "{\"text\":\"§lSturdiness§r\\n§oMace\\nMax level: 5§r\\n\\nIncreases damage to armored enemies. More armor means more damage (capped at 5). \"}" as string, "{\"text\":\"§lTamer§r\\n§oHogwhip§r\\n\\nStuns nearby hoglins instead of scaring them.\"}" as string, "{\"text\":\"§lThunder God§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nRight click summons a lightning strike with a range of 15 blocks.\"}" as string, "{\"text\":\"§lThunder Strike§r\\n§oHammer\\nMax level: 3§r\\n\\nSneak while attacking to strike targets with lightning.\"}" as string, "{\"text\":\"§lTinted§r\\n§oDamageable items, Lodestone Compass§r\\n\\nCombining the item with dye in an anvil changes the enchantment glint color.\"}" as string, "{\"text\":\"§lTwo-Handed§r\\n§oMace§r\\n\\nIncreases damage if offhand is empty and adds a chance to stun the target.\"}" as string, "{\"text\":\"§lUndertaker§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, shovel attacks have a chance to stun the target.\"}" as string, "{\"text\":\"§lVein Mining§r\\n§oTools§r\\n\\nMines the entire cluster of blocks at once. Sneak to disable.\"}" as string, "{\"text\":\"§lVision of Abyss§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nGrants a 5 percent chance to receive positive status effects in a fight.\"}" as string, "{\"text\":\"§lVision of Ender§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nRight click teleports to the target block. Cooldown of 10 seconds.\"}" as string, "{\"text\":\"§lVision of Life and Death§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nTurns the user into a ghost for a few seconds. Cooldown of up to 5 minutes.\"}" as string, "{\"text\":\"§lVoid Vision§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nGrants a 65 percent chance to afflict the target with Blindness and Slowness.\"}" as string, "{\"text\":\"§lVolcanic Mark§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, slingshot projectiles mark enemies. Melee critical strikes on a marked enemy deal more damage and ignite them.\"}" as string, "{\"text\":\"§lWither God§r\\n§oUnknown/Unorithe/ Knight Swords§r\\n\\nGrants a 2 percent chance to afflict the target with Wither.\"}" as string, "{\"text\":\"§lYatagaratsu§r\\n§oBlazing Journal§r\\n\\nWhile blazing journal is held in offhand, sword attacks teleport you behind the target.\"}" as string, "{\"text\":\"§nIncompatibilities§r\\n\\nThe Abyss enchants (Fire Bite, Luck of Thunder, Thunder God, Vision of Abyss/ Ender/Life and Death, Void Vision, Wither God) are all compatible with each other, except Thunder God with Vision of Ender/Life and Death.\"}" as string, "{\"text\":\"The Abyss enchants are not compatible with Health Steal, Poison Blade, or Tinted.\\n\\nPoison Blade is also incompatible with Fire Aspect. \"}" as string], title: "Enchant Info" as string, author: "Hypermoron" as string}), [
    [<item:minecraft:book>, <item:minecraft:enchanting_table>]
]);
craftingTable.removeRecipe(<item:theabyss:ring_of_ghosts>);
craftingTable.removeRecipe(<item:theabyss:ring_of_spectral>);
craftingTable.removeRecipe(<item:villagertools:key>);